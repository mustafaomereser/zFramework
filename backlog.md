...
- [x] **`NotIn.php:20` — `{blocked}` listesi hesaplanıyor, hiçbir dil dosyası basmıyor**
...
- [x] **`File.php:104` — `UPLOAD_ERR_NO_FILE` kontrolü yok**
...
- [x] **`resource/lang/tr/validator.php` — 7 yeni kural Türkçe karaktersiz**
...
- [x] `fix(Date)` format() her timestampi 1970 basiyordu — `112ba75`
