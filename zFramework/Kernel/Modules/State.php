...
class State
{
    ...
    private const BOOT_STATE = [
        ...
        'zFramework\Core\Facades\Mongo::$managers'      => 'one MongoDB Manager per connection per process; the extension pools and reconnects itself',
        ...
        # CLI only: schedule/ is included by `php terminal schedule run` and
        # by nothing else, so neither of these is ever set during a request.
        'zFramework\Core\Facades\Schedule::$tasks'    => 'registered by schedule/, in the terminal process',
